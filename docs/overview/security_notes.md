...
and [`COMPONENTS.app_dirs`](../reference/settings.md#django_components_lite.app_settings.ComponentsSettings.app_dirs))
...
[other common formats](../reference/settings.md#django_components_lite.app_settings.ComponentsSettings.static_files_allowed).

!!! note

    If you need to expose different file formats, you can configure these with
    [`COMPONENTS.static_files_allowed`](../reference/settings.md#django_components_lite.app_settings.ComponentsSettings.static_files_allowed)
    and [`COMPONENTS.static_files_forbidden`](../reference/settings.md#django_components_lite.app_settings.ComponentsSettings.static_files_forbidden).
...
From _v0.27_ until _v0.100_, django-components shipped with an additional installable app _django_components_lite.**safer_staticfiles**_.
...
INSTALLED_APPS = [
    ...
    'django_components_lite.safer_staticfiles'  # <-- ADD
]
```
