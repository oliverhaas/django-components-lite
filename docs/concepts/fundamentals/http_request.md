...
explicitly to [`Component.render()`](../../../reference/api#django_components_lite.Component.render) and
[`Component.render_to_response()`](../../../reference/api#django_components_lite.Component.render_to_response).
...
- The component is rendered with a regular [`Context`](https://docs.djangoproject.com/en/5.2/ref/templates/api/#django.template.Context) (or none), but you set the `request` kwarg
    of [`Component.render()`](../../../reference/api#django_components_lite.Component.render).
...
When the component has access to the `request` object, the request object will be available in [`Component.request`](../../../reference/api/#django_components_lite.Component.request).
...
You can also access the context processors data from within [`get_template_data()`](../../../reference/api#django_components_lite.Component.get_template_data) and other methods under [`Component.context_processors_data`](../../../reference/api#django_components_lite.Component.context_processors_data).
...
!!! warning
    ...
    The [`self.context_processors_data`](../../../reference/api/#django_components_lite.Component.context_processors_data) object is generated dynamically, so changes to it are not persisted.
