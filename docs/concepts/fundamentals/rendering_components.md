...
For a component to be renderable with the [`{% component %}`](../../../reference/template_tags#component) tag, it must be first registered with the [`@register()`](../../../reference/api/#django_components_lite.register) decorator.
...
[`context_behavior`](../../../reference/settings#django_components_lite.app_settings.ComponentsSettings.context_behavior)
...
The [`Component.render()`](../../../reference/api/#django_components_lite.Component.render) method renders a component to a string.
...
[`Component.render()`](../../../reference/api/#django_components_lite.Component.render) accepts the following arguments:
...
See the API reference for [`Component.render()`](../../../reference/api/#django_components_lite.Component.render)
for more details on the arguments.

## `render_to_response()` method

The [`Component.render_to_response()`](../../../reference/api/#django_components_lite.Component.render_to_response)
method works just like [`Component.render()`](../../../reference/api/#django_components_lite.Component.render),
but wraps the result in an HTTP response.

It accepts all the same arguments as [`Component.render()`](../../../reference/api/#django_components_lite.Component.render).
...
By default, [`Component.render_to_response()`](../../../reference/api/#django_components_lite.Component.render_to_response)
returns a standard Django [`HttpResponse`](https://docs.djangoproject.com/en/5.2/ref/request-response/#django.http.HttpResponse).

You can customize this by setting the [`response_class`](../../../reference/api/#django_components_lite.Component.response_class)
...
[`render()`](../../../reference/api/#django_components_lite.Component.render) and [`render_to_response()`](../../../reference/api/#django_components_lite.Component.render_to_response)
accept a `deps_strategy` parameter, which controls where and how the JS / CSS are inserted into the HTML.

The `deps_strategy` parameter is ultimately passed to [`render_dependencies()`](../../../reference/api/#django_components_lite.render_dependencies).
...
- [`ignore`](../../advanced/rendering_js_css#ignore)
    - HTML is left as-is. You can still process it with a different strategy later with
      [`render_dependencies()`](../../../reference/api/#django_components_lite.render_dependencies).
...
The [`render()`](../../../reference/api/#django_components_lite.Component.render) and [`render_to_response()`](../../../reference/api/#django_components_lite.Component.render_to_response) methods accept an optional `context` argument.
...
When you call [`Component.render()`](../../../reference/api/#django_components_lite.Component.render) directly from Python,
...
Neither [`Component.render()`](../../../reference/api/#django_components_lite.Component.render)
nor [`Component.render_to_response()`](../../../reference/api/#django_components_lite.Component.render_to_response)
are typed, due to limitations of Python's type system.

## Components as input

django_components_lite makes it possible to compose components in a "React-like" way,
...
Django components defines a special "dynamic" component ([`DynamicComponent`](../../../reference/components#django_components_lite.components.dynamic.DynamicComponent)).
...
```py
from django_components_lite import DynamicComponent
...
you can set the
[`COMPONENTS.dynamic_component_name`](../../../reference/settings#django_components_lite.app_settings.ComponentsSettings.dynamic_component_name)
