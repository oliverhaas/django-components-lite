...
logger = logging.getLogger("django_components_lite")
...
def trace_component_msg(
    ...
    full_msg = f"{action} COMPONENT: '{component_name}' {component_id_str} {slot_name_str} {slot_fills_str} {component_path_str} {extra}"
