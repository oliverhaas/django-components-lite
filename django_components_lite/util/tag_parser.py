...
class TagValue:
    ...
    compiled: FilterExpression | None = None
    ...
    def compile(self, parser: Parser | None) -> None:
...
class TagValueStruct:
    ...
    def serialize(self) -> str:
        ...
        def render_value(value: TagValue | TagValueStruct) -> str:
    ...
    def compile(self) -> None:
        ...
        def compile_value(value: TagValue | TagValueStruct) -> None:
            if isinstance(value, TagValue):
...
def parse_tag(text: str, parser: Parser | None) -> tuple[str, list[TagAttr]]:
    """
    ...
    def is_next_token(tokens: list[str] | tuple[str, ...]) -> bool:
        if not tokens:
    ...
    def take_until(
        ...
        while not is_at_end():
            ...
            ignore_token_match: str | None = None
    ...
    # tag_name = take_while([" ", "\t", "\n", "\r", "\f"])
    def take_while(tokens: list[str] | tuple[str, ...]) -> str:
        result = ""
        while not is_at_end():
            char = text[index]
    ...
    def extract_spread_token(curr_struct: TagValueStruct, filter_token: str | None) -> str | None:
    ...
    while not is_at_end():
        ...
        while len(stack) > 0:
            ...
            if is_next_token(["}"]):
                ...
                dict_pair: list[TagValueStruct | TagValue] = []
            ...
            while not end_of_value:
                ...
                if is_next_token(["'", '"', "_("]):
                    ...
                    # See https://docs.djangoproject.com/en/5.2/topics/i18n/translation/#string-literals-passed-to-tags-and-filters
