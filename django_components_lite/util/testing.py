...
from django_components_lite.component import ALL_COMPONENTS, Component, component_node_subclasses_by_name
from django_components_lite.component_registry import ALL_REGISTRIES, ComponentRegistry
...
class GenIdPatcher:
    ...
    def start(self) -> None:
        ...
        self._gen_id_patch = patch("django_components_lite.util.misc.generate", side_effect=mock_gen_id)
...
def djc_test(
    ...
    parametrize: tuple[Sequence[str], Sequence[Sequence[Any]]]
    | tuple[
        Sequence[str],
...
def _merge_django_settings(
    ...
    components_settings: Union[Mapping[str, Any], "ComponentsSettings"] | None = None,
) -> dict[str, Any]:
    """
...
def _components_to_mapping(
    value: Union[Mapping[str, Any], "ComponentsSettings"] | None,
) -> dict[str, Any]:
    if value is None:
        return {}
